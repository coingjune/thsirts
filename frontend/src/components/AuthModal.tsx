            ...
            <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md m-4" onClick={e => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button 
                        type="submit" 
                        disabled={isLoading} 
                        className="w-full bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:bg-indigo-400 flex justify-center items-center"
                    >
                        {isLoading ? (
