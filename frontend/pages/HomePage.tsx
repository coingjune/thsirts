...
const HomePage: React.FC<HomePageProps> = ({ setRoute }) => (
    <div className="relative h-[calc(100vh-4rem)] bg-cover bg-center" style={{ backgroundImage: "url('/mainbackground.png')" }}>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center h-full text-center text-white px-4">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-4">Seoul:숨</h1>
            <p className="max-w-2xl text-lg md:text-xl text-gray-200 mb-8">당신만의 특별한 서울, 숨결처럼 소중한 순간을 담으세요.</p>
